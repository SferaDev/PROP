...
public class TerminalConstants {
     ...
     * The Main menu title.
     */
    public static final String MAIN_MENU = "Mastermind: Menu Principal";
    /**
     * The Main register title.
     */
    public static final String MAIN_REGISTER = "Registrar-se";
    /**
     * The Main login title.
     */
    public static final String MAIN_LOGIN = "Identificar-se";
    /**
     ...
     */
    public static final String PLAY_NEW_GAME = "Nova partida";
    /**
     * The Play prev game title.
     */
    public static final String PLAY_PREV_GAME = "Continuar partida";
    /**
     ...
     */
    public static final String NEW_GAME_BREAKER = "Breaker";
    /**
     ...
     */
    public static final String NEW_GAME_FIVEGUESS = "FiveGuessComputer";
    /**
     ...
     * The New menu title.
     */
    public static final String PREVIOUS_GAME_MENU = "Mastermind: Jocs guardats";
